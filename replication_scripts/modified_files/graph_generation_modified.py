...
def generate_graphs(
    ...
    # Parent-paper baseline run: keep all novel features OFF
    log_metrics = False
    ...
    # Parent-paper baseline run: no diversity reranking, no metrics logging
        ...
        for j in range(d):
            ...
            for i in range(len(topk_recommendations)):
                ...
                if np.random.binomial(1, gamma):
                    ...
                    # Parent-paper baseline: no diversity reranking
                    ...
                    # Parent-paper baseline: no diversity metrics logging
